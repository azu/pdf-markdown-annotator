...
`;
    ...
    render() {
        ...
        if (editorStore.isReadonly()) {
            previewButton =
                <button onClick={this.onChangeMode.bind(this,false)}><span className="fa fa-pencil">Editor</span></button>
        } else {
            previewButton =
                <button onClick={this.onChangeMode.bind(this,true)}><span className="fa fa-eye">Preview</span></button>
        }
        return (
